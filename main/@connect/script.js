...
`,
    ...
    const Gp = class {
        ...
        static sanitizeName(t) {
            return t.replace(/[^А-ЯЁA-Z0-9\u00A1\u0020-\u002F\u00BF-\u00FF\u2026!?*$+\-'_ .,]/gi, "").replace(/'/g, "\u2019")
        }
...
${n.message}`,
    ...
    const J3 = {
        ...
        Z3 = {
            DISCONNECTED: "Вы были отсоединены.",
            DRAWING_NOTHING: "Вам нужно что-то нарисовать!",
            PLAYER_KICKED: "Модератор выгнал вас из игры.",
            ROOM_DESTROYED: "Спасибо за игру!",
            ROOM_DISCONNECTED: "Отсоединено",
            TEXT_NAUGHTY: "Обойдёмся без таких словечек. Уважайте других игроков.",
            TEXT_NOTHING: "Вам нужно что-то написать!",
            TITLE: "Error"
        },
        eH = "LOADING",
        tH = {
        ...
        Xne = ze({
            ...
            methods: {
                async load() {
                    var e;
                    try {
                        const n = await (await fetch("https://raw.githubusercontent.com/Disker-RUS/jackbox-test.github.io/main/main/%40connect/banners.json")).json(),
